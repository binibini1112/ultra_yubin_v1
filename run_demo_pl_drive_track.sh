...
# PL-drive with crane_jh-style YOLO track mode.
# This keeps the camera image untouched and does not force exposure/brightness.
...
# Keep ultra_yubin_v1 camera orientation. Do not import crane_jh rotate/flip.
...
# Recognition profile: use YOLO track/ByteTrack instead of predict-only fast mode.
...
echo "[run_demo_pl_drive_track] PL-drive + YOLO track mode conf=${YOLO_CONF} imgsz=${YOLO_IMGSZ} fast_detect=${YOLO_FAST_DETECT}"
