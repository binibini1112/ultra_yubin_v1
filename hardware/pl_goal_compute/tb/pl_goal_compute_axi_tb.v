...
module pl_goal_compute_axi_tb;
    ...
    initial begin
        ...
        expect_read(REG_PAN_GOAL, 32'd2064);
        expect_read(REG_TILT_GOAL, 32'd2772);
        expect_read(REG_CTRL, 32'd2064);
        expect_read(REG_STATUS, 32'd2772);
        ...
        expect_read(REG_PAN_GOAL, 32'd1952);
        expect_read(REG_TILT_GOAL, 32'd2756);
        expect_read(REG_CTRL, 32'd1952);
        expect_read(REG_STATUS, 32'd2756);

        axi_write(REG_TRACK_CMD, (32'd900 << 8) | 32'h3);
        expect_read(REG_LAST_PAN, 32'd4);
        expect_read(REG_PAN_GOAL, 32'd1856);
        expect_read(REG_TILT_GOAL, 32'd2740);
        expect_read(REG_CTRL, 32'd1856);
        expect_read(REG_STATUS, 32'd2740);

        axi_write(REG_TRACK_CMD, (32'd900 << 8) | 32'h3);
        expect_read(REG_LAST_PAN, 32'd5);
        expect_read(REG_PAN_GOAL, 32'd1760);
        expect_read(REG_TILT_GOAL, 32'd2724);
        expect_read(REG_CTRL, 32'd1760);
        expect_read(REG_STATUS, 32'd2724);
